package com.prompt.resume.network.utils;

import android.text.TextUtils;

import com.google.gson.annotations.SerializedName;
import com.prompt.resume.network.annotation.SerializedEncryption;
import com.prompt.resume.network.annotation.SerializedIgnore;
import com.prompt.resume.network.annotation.SerializedTrim;
import com.prompt.resume.network.encryption.Base64;
import com.prompt.resume.network.encryption.MDUtil;
import com.prompt.resume.network.encryption.RSAUtil;

import java.io.File;
import java.lang.reflect.Field;
import java.security.Key;

import static com.prompt.resume.network.encryption.RSAUtil.BCDEncrypt;
...
public class SerializedUtil {
    ...
    public static Object[] convertToRequestContent(Object args, Field field) throws Exception {
        ...
        if (obj instanceof File) {
            ...
            SerializedTrim serializedTrim;
            serializedTrim = field.getAnnotation(SerializedTrim.class);

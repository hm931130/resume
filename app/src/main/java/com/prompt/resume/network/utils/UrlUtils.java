...
import com.prompt.resume.common.AppConfig;
...
public class UrlUtils {
    ...
    private UrlUtils() {
        ...
        commonParamsTreeMap.put(Constant.VERSION_NUMBER, AppUtils.getAppVersionName());
        commonParamsTreeMap.put(Constant.LOGINCLIENT, BaseParams.MOBILE_TYPE);
    ...
    public Map signParams(Map<String, String> treeMap) {
        ...
        headMap.put(Constant.SESSIONID, "cece34a2e6574f4d9ec2d78f69a82031");
        return headMap;
    }

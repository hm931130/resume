package com.prompt.resume.utils.FloatWindowUtil;
...
public class SettingsCompat {
    ...
    public static void manageDrawOverlays(Context context) {
        ...
        try {
            ...
            } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) { //18-23
                if (!manageDrawOverlaysForRom(context)) {
                    startApplicationSetting((Activity) context);
                }
            }
        } catch (Exception e) {
            startApplicationSetting((Activity) context);
...
//        }
     ...
     * @param activity
     */
    private static void startApplicationSetting(Activity activity) {

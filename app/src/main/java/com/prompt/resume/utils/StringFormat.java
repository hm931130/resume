...
public class StringFormat {
    ...
    public static String twoDecimalFormatFromInt(int integer) {
        String money = integer + "";
        DecimalFormat df = new DecimalFormat("######0.00");
        return df.format(ConverterUtil.getDouble(money));
    ...
    public static String doubleFormat(Object args) {
        if (args != null && !TextUtils.isEmpty(args.toString())) {
    ...
    public static String doubleFormatForW(Object args) {
        if (null != args && !TextUtils.isEmpty(args.toString())) {
            String number = args.toString();
            try {
    ...
    public static String getMonthAndDay(String time) {
        ...
        try {
            ...
            returnStr = date.getMonth() + "/" + date.getDay();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static SpannableString getAmountFormater(String amount) {
        if (TextUtils.isEmpty(amount)) return null;
        String priceStr = "¥" + StringFormat.twoDecimalFormat(amount);
        SpannableString sp = new SpannableString(priceStr);
        sp.setSpan(new AbsoluteSizeSpan(18, true), 0, 1, Spannable.SPAN_INCLUSIVE_INCLUSIVE);
        sp.setSpan(new AbsoluteSizeSpan(38, true), 1, priceStr.length(), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
        return sp;
    }
    public static SpannableString getAmountSmallFormater(Object amount) {
        if (TextUtils.isEmpty(amount.toString())) return null;
        String priceStr = "¥" + StringFormat.twoDecimalFormat(amount);
        SpannableString sp = new SpannableString(priceStr);
        sp.setSpan(new AbsoluteSizeSpan(8, true), 0, 1, Spannable.SPAN_INCLUSIVE_INCLUSIVE);
        sp.setSpan(new AbsoluteSizeSpan(16, true), 1, priceStr.length(), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
        return sp;
    }

    public static SpannableString getAmountNoDount(Object amount) {
        if (TextUtils.isEmpty(amount.toString())) return null;
        String priceStr = "¥" + amount;
        SpannableString sp = new SpannableString(priceStr);
        sp.setSpan(new AbsoluteSizeSpan(18, true), 0, 1, Spannable.SPAN_INCLUSIVE_INCLUSIVE);
        sp.setSpan(new AbsoluteSizeSpan(38, true), 1, priceStr.length(), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
        return sp;
    ...
    public static SpannableString getAmountNoDountSmall(Object amount) {
        if (amount != null && !TextUtils.isEmpty(amount.toString())) {
            String priceStr = "¥" + amount;
            SpannableString sp = new SpannableString(priceStr);
            sp.setSpan(new AbsoluteSizeSpan(10, true), 0, 1, Spannable.SPAN_INCLUSIVE_INCLUSIVE);
            sp.setSpan(new AbsoluteSizeSpan(20, true), 1, priceStr.length(), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
            return sp;
        } else {

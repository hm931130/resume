...
import com.prompt.resume.views.MarqueeText;
...
public class TitleBar extends ViewGroup implements View.OnClickListener {
     ...
     * 右侧字体大小
     */
    private int ICONFONT_ACTION_RIGHT_TEXT_SIZE = 18;
    /**
     * 标题栏高度
     */
    private int TITLE_BAR_HEIGHT = 48;
...
//        mLeftText.setCompoundDrawablesWithIntrinsicBounds(resId, 0, 0, 0);
    ...
    public void addActions(ActionList actionList) {
        ...
        System.out.println("actionsize:" + actions);
    ...
    private View inflateAction(Action action) {
        ...
        if (action instanceof ImageAction) {
            ...
            text.setTypeface(iconTypeFace);
            text.setGravity(Gravity.CENTER);
            text.setText(action.getText());
            text.setTextSize(ICONFONT_ACTION_RIGHT_TEXT_SIZE);
            if (mRightTextColor != 0) {
                text.setTextColor(mRightTextColor);
            }
            view = text;
...
//        view.setPadding(mActionPadding, 0, mActionPadding, 0);
    ...
    public static abstract class IconFontAction implements Action {
        ...
        public IconFontAction(String text) {
            mText = text;
        }

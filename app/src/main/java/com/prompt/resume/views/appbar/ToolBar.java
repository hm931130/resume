package com.prompt.resume.views.appbar;
...
import com.prompt.resume.utils.DensityUtil;
...
//        titleBar.setLeftImageResource(R.drawable.app_bar_back);
        ...
        if (typedArray.hasValue(R.styleable.ToolBar_subTitleColor)) {
            subTitleColor = typedArray.getColor(R.styleable.ToolBar_subTitleColor, Color.BLACK);
            titleBar.setSubTitleColor(subTitleColor);
        }
        /**-------------获取右侧文本属性------------*/
        if (typedArray.hasValue(R.styleable.ToolBar_rightColor)) {
            rightColor = typedArray.getColor(R.styleable.ToolBar_rightColor, Color.BLACK);
        ...
        if (typedArray.hasValue(R.styleable.ToolBar_barBackground)) {
            ...
            backgroundResId = R.color.color_white;
        }
    ...
    /**
     * 设置titleBar背景，可接收color或drawable
     *
     * @param resId
     */
    public void setTitleBarBg(@DrawableRes int resId) {
    ...
    public static void appleftText(View view, String value) {
        ((ToolBar) view).setLeftText(value);
    }

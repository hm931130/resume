...
public class CityPickerDialogFragment extends DialogFragment implements TextWatcher,
    ...
    private List<RecentCity> mRecentCities;
    ...
    public void setRecentCities(List<RecentCity> data) {
        if (data != null && !data.isEmpty()) {
            this.mRecentCities = data;
        }
    }
    ...
    private void initViews() {
        ...
        mBackIv = mContentView.findViewById(R.id.backIv);
        ...
        mAdapter = new CityListAdapter(getActivity(), mAllCities, mHotCities, mRecentCities, locateState);
    ...
    private void initData() {
        ...
        mAllCities.add(1, new RecentCity("最近访问", "未知", "0"));

 ...
 * @Date: 2018/2/8 21:22
 */
public class GridRecentAdapter extends RecyclerView.Adapter<GridRecentAdapter.GridViewHolder>{
    public static final int SPAN_COUNT = 4;

    private Context mContext;
    private List<RecentCity> mData;
    private InnerListener mInnerListener;

    public GridRecentAdapter(Context context, List<RecentCity> data) {
